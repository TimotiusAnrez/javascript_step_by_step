...
```
    ...
    - Bila sudah benar semua masukan ke github
    - Checkout branch dengan nama variable_<nama latihan>_<nama kalian>
    -   add file ketika selesai mengerjakan
    -   commit dengan pesan "Telah selesai mengerjakan <nama exercise>"
    -   push ke branch variable_<nama latihan>_<nama kalian>
```